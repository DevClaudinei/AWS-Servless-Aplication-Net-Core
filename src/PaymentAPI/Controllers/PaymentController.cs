...
public class PaymentsController : ControllerBase
{
    ...
    public async Task<IActionResult> Post(CreateVendaRequest vendaRequest)
    {
        try
        {
            var vendaId = await _vendaAppService.CadastrarVenda(vendaRequest);
    ...
    public async Task<IActionResult> GetById(string id)
    {
        try
        {
            var vendaEncontrada = await _vendaAppService.BuscarVendaPorId(id);
    ...
    [ProducesResponseType(typeof(string), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public IActionResult Put(string id, UpdateVendaRequest updateVendaRequest)
    {
        try
        {
